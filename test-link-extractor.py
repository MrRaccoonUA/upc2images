...
class TestStringMethods(unittest.TestCase):
    ...
    def test_api_search(self):
        ...
        New_Link = namedtuple('New_Link', 'resized_link')
        expected_result = New_Link(resized_link='https://i5.walmartimages.com/asr/20206185-284f-4e84-bba8-6243f97b65f3_1.0eeeaf4c0e89999e4ad28b38fcef5552.jpeg')
